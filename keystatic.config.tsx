...
const collections = {
	...
	steeringCommittee: createCollection("/steering-committee/", (path, assetPath, locale) => {
		return collection({
			label: `Steering committee (${locale})`,
			path,
			slugField: "lastName",
			format: { contentField: "content" },
...
export default config({
	ui: {
		...
		navigation: {
			HomePage: ["de_indexPage", "en_indexPage"],
			Pages: ["de_pages", "en_pages"],
			Events: ["de_events", "en_events"],
			SteeringCommittee: ["de_steeringCommittee", "en_steeringCommittee"],
	...
	collections: {
		...
		de_steeringCommittee: collections.steeringCommittee("de"),
		en_steeringCommittee: collections.steeringCommittee("en"),
	},
	singletons: {
